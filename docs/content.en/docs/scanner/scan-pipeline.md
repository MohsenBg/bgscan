...
- DNSTT, VayDNS, Slipstream, MasterDNS, StormDNS, and TheFeed: the tunnel came up and validated (DNSTT, VayDNS, and Slipstream validate through the local SOCKS5 port)
