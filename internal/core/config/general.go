...
type GeneralConfig struct {
	...
	MaxSuccessfulIPs int        `toml:"max_successful_ips" comment:"Stop after N successful results. 0 = scan all targets."`
...
var generalDefaults = map[Platform]map[Tier]GeneralConfig{
	Server: {
		Low: GeneralConfig{
			StatusInterval: NewDurationMS(1 * time.Second), MaxSuccessfulIPs: 0, MaxIPsToTest: 0,
